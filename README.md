...
- **花笺特别篇** — 漫游第二入口（列表仍是主路径）：
  - `/garden` 花庭：落花遇见世界
  - `/w/:world` 世界门槛：作品/诗境/学习/实验/关于（构建期策展）
  - `/desk/:slug` 旗舰案头：Lumen / PolyCodeHub / EvoCode
  - `/stories/:slug` 开卷叙事
  - `/room` 3D 书房（无 WebGL 时降级为索引简本）
  - `/bench` 纸面终端工具墙
...
| 14 | 技术架构设计 | 分层、模块、数据流 |
| 15 | 演进路线 | Wave 1–3 与特别篇拍板 |
| 16 | 花笺特别篇设计 | 视觉与信息架构 |
| 17 | 花笺 Phase 1 规格 | 花庭实现权威 |
